...
If every infinitesimal two-coordinate rotation were invisible to bounded
Fourier statistics, the coordinate law would have to be Gaussian.
...
The following lemma is the point at which the Fourier statistic becomes a
rigidity tool.
...
estimate behind the finite-frequency tests used below.
