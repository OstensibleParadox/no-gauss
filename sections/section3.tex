...
$\sum_{i>N_0}\operatorname{err}_i<\infty$. Choose the local
...
Write \(\nu_T=(\nu_T)_{\mathrm{ac}}+(\nu_T)_{\mathrm{s}}\) for its Lebesgue decomposition relative to
\(\mu\).  Choose a Borel \(\mu\)-null set \(N_0\) supporting
\((\nu_T)_{\mathrm{s}}\), and let \(N=\bigcup_{a\in\mathcal A}(N_0+a)\).
Quasi-invariance of \(\mu\) makes \(N\) a \(\mu\)-null set;
it is exactly \(\mathcal A\)-invariant and still supports \((\nu_T)_{\mathrm{s}}\).
Thus \(\nu_T(N)=(\nu_T)_{\mathrm{s}}(\R^{\N})\in\{0,1\}\) by ergodicity.  Mass one gives
