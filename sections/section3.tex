...
We next convert the one-dimensional Fourier obstruction into a matrix norm.
The argument has two layers.  The Fisher operator identifies the infinitesimal
geometry, while finite Fourier sums provide bounded dual witnesses with norms
that do not grow with the ambient dimension.  The resulting local estimate is
then globalized modulo the discrete stabilizer in
