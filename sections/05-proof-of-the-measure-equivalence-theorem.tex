...
\begin{equation}
 ...
 \label{eq:unit-row-gaussian-residual}
\end{equation}
...
\eqref{eq:unit-row-gaussian-residual} already makes $X$ Gaussian.
...
\eqref{eq:unit-row-gaussian-residual} $k$ times gives
\begin{equation}
 \phi(t)=e^{-(1-q^k)t^2/2}
...
\begin{lemma}[Tail rigidity under a second-moment hypothesis]
\label{lem:tail-rigidity}
...
Necessity follows from \cref{lem:tail-rigidity}.  If
...
\end{theorem}
\begin{proof}
Necessity is \cref{lem:tail-rigidity}.  For sufficiency, write
