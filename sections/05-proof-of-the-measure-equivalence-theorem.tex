...
Sufficiency constructs a stable infinite-dimensional likelihood ratio from
finite-coordinate Hilbert--Schmidt approximants.
Necessity proves that any non-Hilbert--Schmidt tail deviation leaves a
Hellinger trace that cannot be hidden by dense mixing.
...
\begin{proof}[Proof of \cref{thm:measure-equivalence} and \cref{prop:finite-coordinate-likelihood-approximation}]
...
\cref{prop:finite-coordinate-likelihood-approximation}.
