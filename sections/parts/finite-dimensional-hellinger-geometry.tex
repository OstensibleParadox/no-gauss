...
Assume in addition that \(f\) is non-Gaussian.  The next lemma turns the
rank-two obstruction from \cref{lem:fourier-ode} into bounded dual witnesses:
finite real combinations of \(1,\cos(\xi x),\sin(\xi x)\), at frequencies
depending on \(f\) but not on the matrix dimension.
