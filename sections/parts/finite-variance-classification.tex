...
distance, and the proposition identifies their limit as an
...
The infinite-dimensional classification supplies the compactness needed to
rule out finite-dimensional almost-symmetries that stay a fixed distance from
the exact linear stabilizer.
