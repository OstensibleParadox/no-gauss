...
Only \(\E X=0\) and \(\E X^2=1\) are needed here.  Since a sample from
\(\mu=\rho^{\otimes\N}\) need not lie in \(\ell^2\), the row action and its
inverse, tail exchanges, and likelihood cocycles require compatible measurable
versions.
...
therefore acts on one common carrier.  No universal pointwise action of all
...
Finite-marginal likelihood ratios form martingales and their affinities
decrease to the full affinity.  Consequently bounded projected Hellinger
energy is an exact equivalence diagnostic, not merely a necessary condition.
