...
with \(\E X=0\) and \(\E X^2=1\). The row-series action is that of
...
We return to the contraction that opened this section. It keeps every
output in the original support, but it leaves a region of positive mass
unreachable. This is exactly what the inverse row condition detects.
...
The rotating-square examples combine two effects: each block can lose
support, and the affinities of infinitely many blocks can tend to zero.
The following form of the product criterion keeps these effects separate.
...
Affinity tells us whether two laws overlap. When supports differ, full
equivalence requires more: neither direction of the likelihood ratio may
lose mass as more coordinates are observed. Uniform integrability expresses
this requirement, and the following tail formula checks both directions at
once.
