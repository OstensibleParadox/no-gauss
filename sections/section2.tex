...
\paragraph{Centering the response.}

Centering is what separates the effect of mixing from the motion of the
mean. For a variable $Y$ with mean \(m\) and characteristic function \(\phi_Y\), put
...
\begin{equation}
 ...
 \end{aligned}
\end{equation}
The last term removes the contribution of the mean. Scaling then changes
only the frequencies, apart from the phase introduced by centering.
