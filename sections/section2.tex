...
$\mathbf X_n=(X_1,\ldots,X_n)\sim\mu_n$.  For
$A\in M_n(\R)$, define the score of the pushforward by $I+tA$ at $t=0$ by
\begin{equation}
 S_A(\mathbf X_n)=\sum_{i,j=1}^n A_{ij}
...
$\GL_n(\R)$, then $t\mapsto U_{A_t}\Omega_n$ is continuously
...
For
\begin{equation}
 H_A(\mathbf X_n):=\sum_i A_{ii}r(X_i)
