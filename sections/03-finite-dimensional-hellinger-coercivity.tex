...
The matrix Fisher operator supplies the infinitesimal metric that all later
...
The matrix Fisher operator gives the correct quadratic form, but the lower bound
...
The rotational Fourier defect from \cref{lem:fourier-ode} is used exactly
...
matrix path.
To keep that pairing uniformly controlled after moving away from the identity, we need one
